...
void Romb::CalculateRomb() //Подсчёт 4 точки ромба и площади
{
	...
	//Например прямые х=5 и у=2х не перпендикулярны.
	...
	else
	{
		...
		cout << "Ромб построен! Нажмите 5 в основном меню для просмотра параметров." << endl;
...
void Romb::MoveRomb()
{
	...
	case 1:
	{
		...
		C.y += addY;
		D.y += addY;
		cout << "Ромб смещён! Нажмите 5 в главном меню чтобы просмотреть его новые параметры." << endl;
